...
<p style="color:red"> Yaptığımız hesaplamalarda, Yurtdışı Merkez Bankaları Swap verisini hatalı topladığımız için Swap Hariç Net Rezervler olduğundan daha küçük (yaklaşık 7 Milyar Dolar) gözükmüştür.Yaptığımız bu hatadan dolayı öncelikle bu araştırmayı paylaşan kişilerden ve kamuoyundan özür dileriz. Bizi hatamız konusunda uyaran İris Cibre'ye ve "atk_1881" adlı Twitter kullanıcısına da teşekkür ederiz. Sayfadaki veriler bu hata ortadan kaldırılacak şekilde düzenlenmiştir.</p>
