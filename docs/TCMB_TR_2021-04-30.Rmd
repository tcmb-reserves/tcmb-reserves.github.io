...
author: 
  ...
  - Ömer Taha Gülberk
   [E-mail](omertahagulberk@hotmail.com)
...
TCMB tarafından yapılan Swap işlemleri ve TCMB rezervleri gündemde geniş bir yer kaplıyor. TCMB’nin açıkladığı Swap verilerinin EVDS veri sisteminde olmaması ve PDF dosyasıyla paylaşılması da Swap verilerinin çekilmesini ve analiz edilmesini zorlaştırıyor. Bu konuyu araştıran birçok ekonomist ve akademisyenin verilere ve rezervlerin son durumuna daha rahat ulaşabilmesi için böyle bir site hazırlama gereği duyduk. Çalışmamızda kullandığımız verileri [TCMB Haftalık Vaziyeti](https://evds2.tcmb.gov.tr/index.php?/evds/serieMarket/collapse_13/5933/DataGroup/turkish/bie_mbblnch/), [TCMB Taraflı Swap İşlemleri](https://www.tcmb.gov.tr/wps/wcm/connect/a6ffdb2f-47d9-4ae9-8c39-5075867aaec3/TCMB+Tarafli+Swap+Islemleri.pdf?MOD=AJPERES&CACHEID=ROOTWORKSPACE-a6ffdb2f-47d9-4ae9-8c39-5075867aaec3-nzm2YQt%22) ve [1 aya kadar vadeli yurt içi para karşılığında döviz forward ve future’ların toplam açık ve fazla pozisyonu](https://www.tcmb.gov.tr/wps/wcm/connect/cc755e33-b5c0-4632-bfe4-2434d35da011/RT20210326TR.pdf?MOD=AJPERES&CACHEID=ROOTWORKSPACE-cc755e33-b5c0-4632-bfe4-2434d35da011-nzliV18)'ndan elde ettik. Bu işlemleri R programını kullanarak yaptık. Hesaplamalarımızı neye göre yaptığımıza dair bilgiler Metodoloji bölümünde bulunmaktadır. Çalışmamız açık kodludur. Hesaplamaları ayrıntılı olarak incelemek isteyenler [GitHub sayfamızı](https://github.com/tcmb-reserves/tcmb-reserves.github.io) ziyaret edebilirler. Yeni veriler açıklandıkça sayfa güncellenecektir.
:::
