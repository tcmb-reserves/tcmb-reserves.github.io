...
yutk <- data.frame(
  ...
  "=1-2-3" = c("Swap Haric Net Rezervler", 
...
det_tab <- data.frame(
  ...
  "9=5.11+5.21+5.22+6+8" = c("Bilanco ici Doviz Yukumlulugu",
  ...
  "10=5.12+5.23" = c("Bilanco ici Altin Yukumlulugu",
  ...
  "11=9+10" = c("Bilanco ici Yukumlulukler",
                paste0(round((tdt[time == zaman]$biy)/1000, 2), " Milyar $"),
                paste0(round((tdt[time == zaman1]$biy)/1000, 2), " Milyar $"),
                paste0(round((tdt[time == ilkk]$biy)/1000, 2), " Milyar $")),
  
  "12" = c("Yurtici Bankalar Swap",
  ...
  "12.1" = c("Yurtici Bankalar Doviz Swapi",
  ...
  "12.2" = c("Yurtici Bankalar Altin Swapi",
  ...
  "13" = c("Yurtdisi Merkez Bankalari Swap",
  ...
  "14=12.1+13" = c("Bilanco Disi Doviz Yukumlulugu",
  ...
  "15" = c("Bilanco Disi Altin Yukumlulugu",
  ...
  "16=12+13" = c("Bilanco Disi Yukumlulukler",
                 paste0(round((tdt[time == zaman]$bdy)/1000, 2), " Milyar $"),
                 paste0(round((tdt[time == zaman1]$bdy)/1000, 2), " Milyar $"),
                 paste0(round((tdt[time == ilkk]$bdy)/1000, 2), " Milyar $")),
  
  "17=1-9" = c("Net Doviz Rezervi",
  ...
  "19=16+17" = c("Net Rezervler",
                 paste0(round((tdt[time == zaman]$netr)/1000, 2), " Milyar $"),
                 paste0(round((tdt[time == zaman1]$netr)/1000, 2), " Milyar $"),
                 paste0(round((tdt[time == ilkk]$netr)/1000, 2), " Milyar $")),
  
  "20=16-14" = c("Swap Haric Net Doviz Rezervi", 
  ...
  "21=17-12.2" = c("Swap Haric Net Altin Rezervi", 
  ...
  "22=19+20" = c("Swap Haric Net Rezervler", 
                 paste0(round((tdt[time == zaman]$shnetr)/1000, 2), " Milyar $"),
                 paste0(round((tdt[time == zaman1]$shnetr)/1000, 2), " Milyar $"),
                 paste0(round((tdt[time == ilkk]$shnetr)/1000, 2), " Milyar $"))
)
